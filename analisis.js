...
function medianaPorPersona(nombrePersona)
{
    ...
    console.log(medianaSalarios);return medianaSalarios;
}
...
const nuevoSalario=ultimoSalario+aumento;return nuevoSalario;
}
const empresas={};
...
{
    if(!empresas[nombre]){console.warn('La empresa no existe');
}else{const empresaYears=Object.keys(empresas[nombre]);
...
const nuevoMediana=ultimaMediana+aumento;return nuevoMediana;
}}
